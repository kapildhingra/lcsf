...
//		return (T[])row;
	...
	{
//		Matrix[] lcsMatrices = null;
		List<Matrix<T>> matrixList = new ArrayList<Matrix<T>>();
		if(coordinates == null)
		{
			matrixList.add(this);
//			lcsMatrices = new Matrix[1];
//			lcsMatrices[0] = this;
		}
		else
		{
...
//		Matrix<Integer>[] lcsMatrices = m1.split(new Coordinate[]{new Coordinate(9,9), new Coordinate(9,9)});
